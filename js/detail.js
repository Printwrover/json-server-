    ...
    fetch(url)
        ...
        .then(products => {
            pro_arr = products.map(pro => {
                ...
                if(id == pro.id)
                return `<div class="col-lg-5 mb-30">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-4">
                        ...
                        <form>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label class="custom-control-label" for="color-4">Ximage dương</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <a href="cart.html"> <button class="btn btn-primary px-3" href="cart.html" onclick="themvaogio(${pro.id},'${pro.name}','${pro.image}',${pro.price})"><i class="fa fa-shopping-cart mr-1"></i> Thêm vào giỏ</button></a>
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="mb-4">1 Đánh giá về "${pro.name}"</h4>
